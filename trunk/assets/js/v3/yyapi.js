...
* userData： 如果是链接文字,链接自定义数据，是一个正整数，如果是普通文字可以没有<br>
* @returns 发送是否成功。 0=成功 非0值参考错误代码。
* @type Number
*/
...
/**
* 创建一个临时语音房间。创建后用户自动进入该房间。在应用的生命周期内，只能创建一个房间,第二次调用此函数会返回已经创建的房间的rid。房间中能够发言的人数有限，先要先得，目前暂定为5人。
    ...
    try {
        ...
        switch (arguments[0]) {
            ...
            case "IChannelAppMsg_SendMsgToUsers":
                //yytrace("IChannelAppMsg_SendMsgToUsers(\"[" + arguments[1].toString() + "]\",\"" + arguments[2] + "\"," + arguments[3] + "," + arguments[4] + "," + arguments[5] + ");");
            ...
            case "IChannelMicList_GetMicList":
                //yytrace("IChannelMicList_GetMicList();");
            ...
            case "IChannelUserController_GetUserSubChannelId":
                //yytrace("IChannelUserController_GetUserSubChannelId(" + arguments[1] + ");");
