...
2.什么是“播放模式”
	...
	删除，点“删除”按钮，删除当前选中的音乐，或者把要删除的音乐“拖动”到按钮上面，就删除了！
	保存，在未登录的情况下，默认是保存在本地的，登录后就是保存在你的歌单里了
...
5.浏览器地址里的“前进”，“后退”
	浏览器里的“前进”与“后退”分别是你播放的上一首，在“电台模式”下不会记录你的上一首。
	如果要记录，请你登录后，就自动记录在你的“听过的”里面。
...
6.歌单，属于你自己的歌曲播放列表，这功能必须登录后才能使用
	...
	保存，保存歌曲到歌单，可以把你当前列表里的音乐永久保存起来，方便随时加载到当前列表里播放。
...
7.多语言版本，目前只支持下如下种，其中英文，繁体中文还不是完全支持。
	英文/繁体中文/简体中文</pre>
