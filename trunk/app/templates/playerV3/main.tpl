...
<html>
	<head>
		...
		<script type="text/javascript" src="/assets/js/ui-1.9.m5/jquery.ui.core.js"></script>
		<script type="text/javascript" src="/assets/js/ui-1.9.m5/jquery.ui.widget.js"></script>
		<script type="text/javascript" src="/assets/js/ui-1.9.m5/jquery.ui.mouse.js"></script>
		<script type="text/javascript" src="/assets/js/ui-1.9.m5/jquery.ui.position.js"></script>
		<script type="text/javascript" src="/assets/js/ui-1.9.m5/jquery.ui.autocomplete.js"></script>
		<script type="text/javascript" src="/assets/js/ui-1.9.m5/jquery.ui.resizable.js"></script>
		<script type="text/javascript" src="/assets/js/ui-1.9.m5/jquery.ui.sortable.js"></script>
		<script type="text/javascript" src="/assets/js/ui-1.9.m5/jquery.ui.draggable.js"></script>
		<script type="text/javascript" src="/assets/js/ui-1.9.m5/jquery.ui.droppable.js"></script>
